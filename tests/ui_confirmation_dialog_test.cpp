...
TEST_F(ConfirmationDialogTest, Constructor_CreatesDialog) {
    EXPECT_NE(dialog, nullptr);
}

TEST_F(ConfirmationDialogTest, Constructor_InitiallyHidden) {
...
TEST_F(ConfirmationDialogTest, ProcessMouseEvent_Hidden_ReturnsFalse) {
    ...
    MouseEvent event{100, 100, false, false, true, true, false, false, false, false, false, false, 0.0f};
...
TEST_F(ConfirmationDialogTest, ProcessMouseEvent_Visible_BlocksLowerLayers) {
    ...
    MouseEvent event{5000, 5000, false, false, true, true, false, false, false, false, false, false, 0.0f};
...
TEST_F(ConfirmationDialogTest, ModalBehavior_BlocksUnderlyingUI) {
    ...
    MouseEvent click_event{150, 120, false, false, true, true, false, false, false, false, false, false, 0.0f};
