...
size_t LinearAllocator::AllocatedSize() const { return offset_; }

size_t LinearAllocator::PeakSize() const { return peak_offset_; }

size_t LinearAllocator::Remaining() const { return capacity_ - offset_; }
...
size_t PoolAllocator::AllocatedSize() const { return allocated_blocks_ * block_size_; }

size_t PoolAllocator::PeakSize() const { return peak_allocated_ * block_size_; }

size_t PoolAllocator::AvailableBlocks() const { return block_count_ - allocated_blocks_; }
