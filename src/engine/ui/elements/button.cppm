...
export namespace engine::ui::elements {
    ...
    public:
        ...
        Button(float x, float y, float width, float height, 
               const std::string& label, float font_size = 16.0f)
            : UIElement(x, y, width, height)
            , label_(label)
            , font_size_(font_size)
            , normal_color_(batch_renderer::Colors::DARK_GRAY)
            , hover_color_(batch_renderer::Color::Brightness(batch_renderer::Colors::DARK_GRAY, 0.2f))
            , pressed_color_(batch_renderer::Color::Brightness(batch_renderer::Colors::DARK_GRAY, -0.2f))
            , disabled_color_(batch_renderer::Color::Alpha(batch_renderer::Colors::DARK_GRAY, 0.5f))
            , text_color_(batch_renderer::Colors::WHITE)
         ...
         */
        void SetNormalColor(const batch_renderer::Color& color) {
            normal_color_ = color;
        }
         ...
         */
        void SetHoverColor(const batch_renderer::Color& color) {
            hover_color_ = color;
        }
         ...
         */
        void SetPressedColor(const batch_renderer::Color& color) {
         ...
         */
        void SetDisabledColor(const batch_renderer::Color& color) {
    ...
    private:
        ...
        // State colors
        batch_renderer::Color normal_color_;
        batch_renderer::Color hover_color_;
        batch_renderer::Color pressed_color_;
        batch_renderer::Color disabled_color_;
