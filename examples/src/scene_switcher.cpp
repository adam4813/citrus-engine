...
SceneSwitcher::SceneSwitcher() :
		active_scene_(nullptr), active_scene_name_(""), active_adapter_(nullptr),
...
const std::string& SceneSwitcher::GetActiveSceneName() const { return active_scene_name_; }

bool SceneSwitcher::HasActiveScene() const { return active_scene_ != nullptr; }
