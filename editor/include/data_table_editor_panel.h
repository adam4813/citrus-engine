...
public:
	...
	/**
	 * @brief Import table data from CSV
	 */
...
private:
	...
	// File dialogs
	FileDialogPopup open_dialog_{"Open Data Table", FileDialogMode::Open, {".json"}};
	FileDialogPopup save_dialog_{"Save Data Table As", FileDialogMode::Save, {".json"}};
	FileDialogPopup export_dialog_{"Export CSV", FileDialogMode::Save, {".csv"}};
	FileDialogPopup import_csv_dialog_{"Import CSV", FileDialogMode::Open, {".csv"}};
