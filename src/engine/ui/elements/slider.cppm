...
export namespace engine::ui::elements {
    ...
    public:
        ...
        Slider(float x, float y, float width, float height,
               float min_value, float max_value, float initial_value = 0.0f)
            : UIElement(x, y, width, height)
            , min_value_(min_value)
            , max_value_(max_value)
            , current_value_(std::clamp(initial_value, min_value, max_value))
            , track_color_(batch_renderer::Colors::DARK_GRAY)
            , fill_color_(batch_renderer::Colors::GOLD)
            , thumb_color_(batch_renderer::Colors::WHITE)
            , label_color_(batch_renderer::Colors::WHITE)
            , is_dragging_(false)
            , show_value_(false)
            , label_font_size_(14.0f)
            , value_font_size_(12.0f)
            , label_element_(nullptr)
            , value_element_(nullptr)
         ...
         */
        void SetTrackColor(const batch_renderer::Color& color) {
            track_color_ = color;
        }
         ...
         */
        void SetFillColor(const batch_renderer::Color& color) {
            fill_color_ = color;
        }
         ...
         */
        void SetThumbColor(const batch_renderer::Color& color) {
            thumb_color_ = color;
        }
