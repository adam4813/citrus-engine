...
std::unique_ptr<IScriptingBackend> CreateScriptingBackend(ScriptLanguage language) {
	switch (language) {
	case ScriptLanguage::Lua: return CreateLuaBackend();
	case ScriptLanguage::AngelScript: return CreateAngelScriptBackend();
	case ScriptLanguage::Python:
		// TODO: Implement Python backend
		throw std::runtime_error("Python backend not yet implemented");
	default: throw std::runtime_error("Unknown scripting language");
	}
}
} // namespace engine::scripting
