...
public:
	...
	void Render(engine::Engine &engine) override {
		if (cube_mesh_ == engine::rendering::INVALID_MESH || cube_shader_ == engine::rendering::INVALID_SHADER) {
			return;
		}
		...
		glm::mat4 view = glm::lookAt(
			camera_position_, camera_position_ + glm::vec3(0.0f, 0.0f, -1.0f), glm::vec3(0.0f, 1.0f, 0.0f));
