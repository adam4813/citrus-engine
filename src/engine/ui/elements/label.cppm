...
export namespace engine::ui::elements {
    ...
    public:
         ...
         * @endcode
         */
        Label(float x, float y, const std::string& text, float font_size = 16.0f,
            ...
            , max_width_(0.0f)  // No constraint by default
         ...
         * @return Text color
         */
        batch_renderer::Color GetColor() const {
            return text_color_;
        }
        ...
        void UpdateTextPosition() {
            ...
            switch (alignment_) {
                ...
                case Alignment::Center:
                    text_x = (width_ - text_width) * 0.5f;
                    break;
                case Alignment::Right:
                    text_x = width_ - text_width;
                    break;
            }
