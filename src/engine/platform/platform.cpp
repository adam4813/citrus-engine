...
double Timer::ElapsedSeconds() const { return std::chrono::duration<double>(Elapsed()).count(); }

double Timer::ElapsedMilliseconds() const { return std::chrono::duration<double, std::milli>(Elapsed()).count(); }

double Timer::ElapsedMicroseconds() const { return std::chrono::duration<double, std::micro>(Elapsed()).count(); }
